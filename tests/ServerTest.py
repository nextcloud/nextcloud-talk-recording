...
@pytest.mark.parametrize('address, networks, expectedResult', [
    ...
    ('::ffff:192.168.57.42', ['::ffff:192.168.58.0/120'], False),
    ('::ffff:192.168.57.42', ['::ffff:192.168.57.0/120'], True),
    ('192.168.57.42', ['::ffff:192.168.57.0/120'], False),
    ('::ffff:192.168.57.42', ['192.168.57.0/24'], False),
